...
class SelfBleuReward(object):
    ...
    def __call__(self, texts: List[str]) -> List[float]:
        ...
        输出: List[float]，每个文本与其他文本的总体相似程度
        """
...
def get_similarity_model():
    ...
    if _similarity_model is None:        
        model_path = "../LLMs/all-MiniLM-L6-v2"        
...
class RayAgentTrainer(VerlRayPPOTrainer):
    ...
    def _normalize_process_score_tensor_bak(self, batch):
        ...
        # pdb.set_trace() # check group_rewards 和 group_turn_info
        ...
        # pdb.set_trace() # check normalized_process_rm_scores 和 batch.batch["original_process_rm_scores"]
